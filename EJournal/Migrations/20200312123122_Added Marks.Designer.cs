...
namespace EJournal.Migrations
{
    ...
    [Migration("20200312123122_Added Marks")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EJournal.Data.Entities.JournalColumn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("JournalColumn");
                });

            modelBuilder.Entity("EJournal.Data.Entities.Lesson", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("LessonTimeGap")
                        .IsRequired();
            ...
            modelBuilder.Entity("EJournal.Data.Entities.Mark", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("JournalColumnId");
            ...
            modelBuilder.Entity("EJournal.Data.Entities.MarkType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EJournal.Data.Entities.JournalColumn", b =>
                {
                    b.HasOne("EJournal.Data.Entities.Journal", "Journal")
                        .WithMany("JournalColumns")
                        .HasForeignKey("JournalId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("EJournal.Data.Entities.Lesson", "Lesson")
                        .WithOne("JournalColumn")
                        .HasForeignKey("EJournal.Data.Entities.JournalColumn", "LessonId")
                        .OnDelete(DeleteBehavior.Restrict);
                });

            modelBuilder.Entity("EJournal.Data.Entities.Lesson", b =>
                {
                    b.HasOne("EJournal.Data.Entities.Auditorium", "Auditorium")
                        .WithMany("Lessons")
            ...
            modelBuilder.Entity("EJournal.Data.Entities.Mark", b =>
                {
                    b.HasOne("EJournal.Data.Entities.JournalColumn", "JournalColumn")
                        .WithMany("Marks")
                        .HasForeignKey("JournalColumnId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("EJournal.Data.Entities.MarkType", "MarkType")
                        .WithMany("Marks")
